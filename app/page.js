...
export default function Page() {
  return (
    <main className="relative z-20">
      ...
      <CurateSplitBanner variant="bg-coffee" waveFill='var(--tan)' title="Ние сме Дари, Мето и малката Кая" text=" - семейство приключенци, които вярват, че най-красивите истории се раждат по пътя. След хиляди изминати километри, стотици върхове, безброй минути под вода и под звездите, решихме да създадем нещо наше: Gypsy Vans.
